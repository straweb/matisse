...
define(["matisse", "matisse.fabric", "matisse.comm", "matisse.main", "matisse.containers", "matisse.containers.devices", "matisse.layouts", "features/modified-by-user", "features/shared-users", "features/chat", "matisse.layouts.content", "matisse.palettes", "matisse.palettes.basicshapes", "matisse.palettes.wireframe", "matisse.palettes.components", "matisse.events", "/public/js/thirdparty/csspopup.js", "matisse.help"], function (matisse, mfabric, Comm, main, containers, palettes, layouts, modifiedByUser, sharedUsers, chat) {
    
    "use strict";
	//Dom Ready function
	$(function () {
		var serverURL = 'http://127.0.0.1',//+location.host,//change it to server ip or local ip for testing from other machines
	      ...
	      /**
              ...
              $.get('/userinfo', 
		        ...
		        if(matisse.userName == null) {
                            ...
                            var userInfoKey = info.loginService;
